...
export type AppView = "recipe" | "planning" | "packing" | "breakdown" | "whatif" | "rundmail" | "import";
export type AppSurface = "full" | "kitchen" | "rundmail";

export const ALL_VIEWS: readonly AppView[] = ["recipe", "planning", "packing", "breakdown", "whatif", "rundmail", "import"];
