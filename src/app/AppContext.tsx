...
export type AppView = "heute" | "recipe" | "catalog" | "planning" | "wo" | "pet" | "whatif" | "rundmail" | "import" | "wms" | "blast-chiller" | "allergen-plating" | "postblast-live" | "backfills" | "redzone-live" | "transparency-plan" | "artikel-woche" | "full-inventory" | "plating-plan" | "plating-day" | "kochplan" | "plating-line-bot" | "plating-dashboard" | "daily-briefing";
export type AppSurface = "full" | "kitchen" | "rundmail" | "redzone" | "shopfloor" | "plating" | "staging";

export const ALL_VIEWS: readonly AppView[] = ["heute", "recipe", "catalog", "planning", "wo", "pet", "whatif", "rundmail", "import", "wms", "blast-chiller", "allergen-plating", "plating-line-bot", "postblast-live", "backfills", "redzone-live", "transparency-plan", "artikel-woche", "full-inventory", "plating-plan", "plating-day", "kochplan", "plating-dashboard", "daily-briefing"];
