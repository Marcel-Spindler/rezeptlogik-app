...
function fakeBackfillNeed(overrides: Partial<CombinedBackfillNeed> & { recipeCode: string }): CombinedBackfillNeed {
  return {
    ...
    rtiHoldingKg: 0, rtiPlannedTarget: null, rtiActuals: null, rtiShortfallPortions: 0, rtiRecommendedBuffered: 0,
    rtiKitchenDone: false, rtiHasOpenSubs: false, rtiVetoed: false, rtiBackfillCandidateSubs: [], rtiSubShortfalls: [],
