...
function meal(overrides: Partial<RtiMealBackfill> = {}): RtiMealBackfill {
  return {
    ...
    allEntered: false, weighingStarted: true, hasGapOnly: false, headerIncomplete: false,
    targetSource: "sheet", targetEstimated: false, targetSourceLabel: "", candidateSubNames: [],
    ...overrides,
  };
}
