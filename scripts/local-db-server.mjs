...
function planningChatSystemPrompt(context) {
  return [
    ...
    "Täglicher Linienplan (Phase 3): get_day_plating_plan / generate_day_plating_plan sequenzieren die Runs je Tag AUFSTEIGEND nach Allergenen (kein Allergen → viele). Allergen nur zufügen (milk → milk,sulphites) = easy Changeover; Allergen weg = volle Reinigung = Saubermach-Aktion; Protein-Wechsel = Full Changeover. L1 Highrunner = größter sauberer Block (0 Reinigungen), L2 Flex nimmt die Reinigungen auf, L3 Overload nur wenn L1+L2 das Volumen nicht fassen. Rest → Carry-over Folgetag (Seafood/komplex = kritisch, harte Deadline). Ziel: minimale Reinigungen. Um die Tagespläne mitzuspeichern: propose_plating_plan mit regenerateDailyPlans:true.",
